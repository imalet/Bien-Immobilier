...
<body>
    ...
    <form action="{{route('enregistre')}}" method="post" enctype="multipart/form-data">
        ...
        <div class="editor mx-auto w-10/12 flex flex-col text-gray-800 border border-gray-300 p-4 shadow-lg max-w-2xl">
            ...
            {{-- nom du Bien --}}
            <input class="title bg-gray-100 border border-gray-300 p-2 mb-4 outline-none" spellcheck="false" placeholder="Ex : Studio Duplex" type="text" name="nom">
            ...
            {{-- Description --}}
            <textarea class="description bg-gray-100 sec  p-3 h-60 border border-gray-300 outline-none" spellcheck="false" placeholder="Décrivez tout ce qu’il faut savoir sur cet article ici..." name="description"></textarea>
            ...
            <label for="nom">Dimensions</label>
            <input class="title bg-gray-100 border border-gray-300 p-2 mb-4 outline-none" spellcheck="false" placeholder="Ex : 20m2" type="text" name="dimension">
            <br>

            <label for="nom">Nombre de balcons</label>
            <input class="title bg-gray-100 border border-gray-300 p-2 mb-4 outline-none" spellcheck="false" placeholder="Ex : 2" type="text" name="balcon">
            <br>

            <label for="nom">Nombre d'espace vert</label>
            <input class="title bg-gray-100 border border-gray-300 p-2 mb-4 outline-none" spellcheck="false" placeholder="Ex : 2" type="text" name="espaceVert">
            <br>

            <label for="nom">Nombre de toilette</label>
            <input class="title bg-gray-100 border border-gray-300 p-2 mb-4 outline-none" spellcheck="false" placeholder="Ex : 2" type="text" name="toilette">
            <br>

            <label for="nombreChambres">Nombre de Chambres:</label>
            <select id="nombreChambres" name="nombreChambres" class="bg-gray-100 border border-gray-300 p-2 mb-4 outline-none" onchange="generateRoomInputs()">
            ...
            <div class="buttons flex justify-end">
                <input class="btn border border-stne-900 p-1 px-4 font-semibold cursor-pointer text-gray-200 ml-2 bg-stone-900" type="submit" value="Creer l'Article">
    ...
    <script>
        function generateRoomInputs() {
            ...
            for (var i = 0; i < numberOfRooms; i++) {
                ...
                dimensionInput.class = 'title bg-gray-100 border border-gray-300 p-2 mb-4 outline-none';
                ...
                var libeleInput = document.createElement('input');
                libeleInput.type = 'text';
                libeleInput.name = 'libelleChambre' + (i + 1);
                libeleInput.placeholder = 'Libelle de la chambre ' + (i + 1);
                libeleInput.required = true;

                roomDiv.appendChild(fileInput);
                roomDiv.appendChild(dimensionInput);
                roomDiv.appendChild(libeleInput);
