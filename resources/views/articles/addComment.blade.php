                        ...
                        <div class="border rounded-md p-3  my-3">
                            ...
                            <div class="flex justify-between items-center">
                                <div>
                                    ...
                                    <a href="{{ route('comment.edit',['article'=>$article->id,'comment'=>$comment->id]) }}"
                                        class="text-gray-500 hover:text-gray-700 mr-4"><i class="far fa-thumbs-up"></i>
                                        Modifier</a>

                                    <a href="{{ route('comment.delete',['id'=>$comment->id]) }}"
                                        class="text-gray-500 hover:text-gray-700"><i class="far fa-comment-alt"></i>
                                        Supprimer</a>
                    ...
                    <form method="post" action="{{ route('comment.add') }}">
                        ...
                        <div class="w-full my-2">
                            <textarea
                                ...
                                required>Merci Pour Le commentaire</textarea>
                        </div>
